...
- current handoff and history status
...
4. Refresh `.agent/PLAN.md`, `.agent/HANDOFF.md`, and `.claude/history.md` before committing.
...
## Common Mistakes
- committing `.agent/*` or `.claude/history.md`
