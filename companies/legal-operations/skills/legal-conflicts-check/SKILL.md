...
description: Run the Sprint 1a manual conflicts-check procedure before substantive legal work begins.
metadata:
  sources:
...
Use this skill before any substantive legal drafting, review, or advice. Sprint 1a does not include an automated conflicts database, so conflicts clearance requires operator confirmation.

## Procedure

1. Collect all party, counterparty, affiliate, counsel, and related matter names from matter intake.
2. State that Sprint 1a cannot automatically verify whether any named party is a current client, former client, adverse party, or otherwise conflicted.
...
9. Document that the check was operator-confirmed and that Sprint 1a does not include automated conflicts screening.
