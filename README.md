...
- **The agents are the interchangeable parts.** 176 atomic agents / 172 skills across 34 teams do the work inside the pipeline, with ten model variants that swap providers per lane without touching the package. The catalog is the supporting cast; the pipeline is the product.
...
│  ├── agents/    (176 AGENTS.md — org chart + routing)    │
