...
`pnpm -C trace-store test` - Run the trace-store node:test suite (49 tests: fail-closed config, canonical hashing, capture modes, role-gated visibility, per-matter store, retention purge, plan evals).
